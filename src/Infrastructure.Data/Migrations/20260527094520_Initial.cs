        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Activity = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Companion = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Amount = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PhoneAssignments_Employees_CaregiverId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SecurityIncidents_Employees_ReportedByEmployeeId",
                        column: x => x.ReportedByEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_SecurityIncidents_Employees_ResolvedByEmployeeId",
            ...
            migrationBuilder.InsertData(
                table: "Residents",
                columns: new[] { "Id", "Activity", "Amount", "Companion", "Department", "DischargedAt", "FirstName", "Info", "Initials", "LastName", "TrafficLightStatus" },
                values: new object[,]
                {
                    { new Guid("694b9796-dc5a-4a68-bafb-0a59595e8fb3"), null, null, null, 0, null, "Anna", null, "AA", "Andersen", 0 },
                    { new Guid("a1b2c3d4-e5f6-7890-1234-56789abcdef0"), null, null, null, 0, null, "Birthe", null, "BB", "Brun", 2 },
                    { new Guid("a6b7c8d9-0123-4567-89ab-cdef01234567"), null, null, null, 0, null, "Gunnar", null, "GG", "Gregersen", 0 },
                    { new Guid("aa000001-0000-0000-0000-000000000001"), null, null, null, 1, null, "Mette", null, "MM", "Madsen", 0 },
                    { new Guid("aa000001-0000-0000-0000-000000000002"), null, null, null, 1, null, "Niels", null, "NN", "Nielsen", 1 },
                    { new Guid("aa000001-0000-0000-0000-000000000003"), null, null, null, 1, null, "Ole", null, "OO", "Olesen", 2 },
                    { new Guid("aa000001-0000-0000-0000-000000000004"), null, null, null, 1, null, "Pia", null, "PP", "Petersen", 0 },
                    { new Guid("aa000001-0000-0000-0000-000000000005"), null, null, null, 1, null, "Rasmus", null, "RR", "Rasmussen", 0 },
                    { new Guid("aa000001-0000-0000-0000-000000000006"), null, null, null, 1, null, "Sofie", null, "SS", "Sørensen", 1 },
                    { new Guid("aa000001-0000-0000-0000-000000000007"), null, null, null, 1, null, "Thomas", null, "TT", "Thomsen", 2 },
                    { new Guid("b7c8d9e0-1234-5678-9abc-def012345678"), null, null, null, 0, null, "Hanne", null, "HH", "Hansen", 2 },
                    { new Guid("bb000002-0000-0000-0000-000000000001"), null, null, null, 2, null, "Ulla", null, "UU", "Ulrichsen", 0 },
                    { new Guid("bb000002-0000-0000-0000-000000000002"), null, null, null, 2, null, "Viggo", null, "VV", "Vestergaard", 2 },
                    { new Guid("bb000002-0000-0000-0000-000000000003"), null, null, null, 2, null, "Winnie", null, "WW", "Winther", 1 },
                    { new Guid("bb000002-0000-0000-0000-000000000004"), null, null, null, 2, null, "Xenia", null, "XX", "Xu", 0 },
                    { new Guid("bb000002-0000-0000-0000-000000000005"), null, null, null, 2, null, "Yvonne", null, "YY", "Yilmaz", 0 },
                    { new Guid("bb000002-0000-0000-0000-000000000006"), null, null, null, 2, null, "Zenia", null, "ZZ", "Zahle", 2 },
                    { new Guid("bb000002-0000-0000-0000-000000000007"), null, null, null, 2, null, "Bent", null, "BA", "Bagger", 0 },
                    { new Guid("bb000002-0000-0000-0000-000000000008"), null, null, null, 2, null, "Connie", null, "CO", "Christoffersen", 1 },
                    { new Guid("bb000002-0000-0000-0000-000000000009"), null, null, null, 2, null, "Dagmar", null, "DA", "Damgaard", 0 },
                    { new Guid("c2d3e4f5-6789-0123-4567-89abcdef0123"), null, null, null, 0, null, "Carl", null, "CC", "Christensen", 1 },
                    { new Guid("c8d9e0f1-2345-6789-abcd-ef0123456789"), null, null, null, 0, null, "Ida", null, "II", "Iversen", 0 },
                    { new Guid("d3e4f5a6-7890-1234-5678-9abcdef01234"), null, null, null, 0, null, "Dorthe", null, "DD", "Dalgaard", 0 },
                    { new Guid("d9e0f1a2-3456-789a-bcde-f01234567890"), null, null, null, 0, null, "Jens", null, "JJ", "Jensen", 0 },
                    { new Guid("e0f1a2b3-4567-89ab-cdef-012345678901"), null, null, null, 0, null, "Karen", null, "KK", "Knudsen", 2 },
                    { new Guid("e4f5a6b7-8901-2345-6789-abcdef012345"), null, null, null, 0, null, "Erik", null, "EE", "Eriksen", 0 },
                    { new Guid("f1a2b3c4-5678-9abc-def0-123456789012"), null, null, null, 0, null, "Lars", null, "LL", "Larsen", 1 },
                    { new Guid("f5a6b7c8-9012-3456-789a-bcdef0123456"), null, null, null, 0, null, "Frida", null, "FF", "Frederiksen", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11223344-5566-7788-99aa-bbccddeeff00"), 1, "Tasks to be completed in the evening.", new DateTime(2026, 5, 27, 23, 45, 20, 33, DateTimeKind.Local).AddTicks(6961), 1, "lave aftensmad" },
                    { new Guid("11223344-5566-7788-99aa-bbccddeeff20"), 0, "Tasks to be completed in the evening.", new DateTime(2026, 5, 27, 23, 45, 20, 33, DateTimeKind.Local).AddTicks(6968), 1, "lave aftensmad" },
                    { new Guid("11223344-5566-7788-99aa-bbccddeeff30"), 2, "Tasks to be completed in the evening.", new DateTime(2026, 5, 27, 23, 45, 20, 33, DateTimeKind.Local).AddTicks(6974), 1, "lave aftensmad" },
                    { new Guid("12345678-1234-5678-1234-567812345678"), 1, "Tasks to be completed in the morning.", new DateTime(2026, 5, 27, 19, 45, 20, 33, DateTimeKind.Local).AddTicks(6941), 1, "indkøb" },
                    { new Guid("12345678-1234-5678-1234-598812345678"), 0, "Tasks to be completed in the morning.", new DateTime(2026, 5, 27, 19, 45, 20, 33, DateTimeKind.Local).AddTicks(6964), 1, "indkøb" },
                    { new Guid("65345678-1234-5678-1234-598812345678"), 2, "Tasks to be completed in the morning.", new DateTime(2026, 5, 27, 19, 45, 20, 33, DateTimeKind.Local).AddTicks(6970), 1, "indkøb" },
                    { new Guid("87654321-4321-8765-4321-598543218765"), 0, "Tasks to be completed in the afternoon.", new DateTime(2026, 5, 27, 21, 45, 20, 33, DateTimeKind.Local).AddTicks(6966), 1, "rengøring" },
                    { new Guid("87654321-4321-8765-4321-876543218765"), 1, "Tasks to be completed in the afternoon.", new DateTime(2026, 5, 27, 21, 45, 20, 33, DateTimeKind.Local).AddTicks(6959), 1, "rengøring" },
                    { new Guid("87695221-4321-8765-4321-598543218765"), 2, "Tasks to be completed in the afternoon.", new DateTime(2026, 5, 27, 21, 45, 20, 33, DateTimeKind.Local).AddTicks(6972), 1, "rengøring" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PhoneAssignments_CaregiverId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SecurityIncidents_ReportedByEmployeeId",
                table: "SecurityIncidents",
                column: "ReportedByEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_SecurityIncidents_ResolvedByEmployeeId",
                table: "SecurityIncidents",
